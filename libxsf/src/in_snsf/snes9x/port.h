...
#else
inline uint16_t READ_WORD(const uint8_t *s) { return (uintptr_t)s | (((uintptr_t)s + 1) << 8); }
inline uint32_t READ_3WORD(const uint8_t *s) { return (uintptr_t)s | (((uintptr_t)s + 1) << 8) | (((uintptr_t)s + 2) << 16); }
